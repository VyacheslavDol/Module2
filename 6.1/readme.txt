Задание 6.1 2 модуль

Задание 4.1 реализовано с созданием статической библиотеки /6.1/library/libmy1.a , для ее создания создан /6.1/library/Makefile,
в каталоге /6.1/library/source находятся исходники исполняемых файлов для функций.
В каталоге /6.1/project находится главный файл с основным кодом task4_1.c и Makefile для создания исполняемого файла task6_1, 
